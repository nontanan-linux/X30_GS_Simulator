...
def reorder_waypoints(file_path):
    ...
    def get_new_node_info(old_info, indices, zone):
        ...
        if old_info.lower().startswith('via'):
            ...
            # Remove any existing digits immediately after 'via' or '_via'
            # ex: via113.1 -> suffix .1? No, usually user wants a clean viaN.
            # But they said ex. via_2nd -> via7_2nd.
            # So suffix is everything after the initial 'via' and potential existing digits.
            
            suffix = ""
            # Find the part after 'via' and optional initial numbers
        ...
        for t in types:
            if t in old_info.lower():
                ...
                modifier = ""
                if "-low" in old_info.lower(): modifier = "-low"
                elif "-crawl" in old_info.lower(): modifier = "-crawl"
...
if __name__ == "__main__":
    path = "/home/nontanan/Gensurv/NestleCat/X30_GS_Simulator/resource/waypoints/record_dry-1.json"
