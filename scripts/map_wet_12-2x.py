...
JSON_FILE_NAME = 'wet_zone_12-2x.json' # The name of the JSON file
JSON_FILE = os.path.join(SCRIPT_DIR, '../resource/waypoints', JSON_FILE_NAME)
OUTPUT_IMAGE = os.path.join(SCRIPT_DIR, 'visualize_wet_12-2x.png') # Output in the same directory as the script
