...
JSON_FILE_NAME = 'wet_zone_3.json' # The name of the JSON file
JSON_FILE = os.path.join(SCRIPT_DIR, '../resource/waypoints', JSON_FILE_NAME)
OUTPUT_IMAGE = os.path.join(SCRIPT_DIR, 'visualize_wet_3.png') # Output in the same directory as the script
